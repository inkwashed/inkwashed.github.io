...
/* add placeholder text for browsers that don’t support placeholder 18attribute */
...
function validateRequired() {
  ...
  try {
    for (var i = 0; i < elementCount; i++) {
      // validate all input elements in fieldset12
...
function validateForm(evt) {
  if (evt.preventDefault) {
    ...
    // prevent form from submitting in IE8 8
  }
  formValidity = true;
